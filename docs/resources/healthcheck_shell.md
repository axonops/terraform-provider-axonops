...
Manages a shell healthcheck configuration for a cluster. Shell health checks execute custom scripts or commands to verify system health, useful for checking disk space, process status, JVM metrics, and other custom conditions.
