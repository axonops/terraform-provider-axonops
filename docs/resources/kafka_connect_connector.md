...
Manages a Kafka Connect connector. Connectors enable streaming data between Kafka and external systems such as databases, cloud services, and file systems.
...
- `connect_cluster_name` - The name of the Kafka Connect cluster
